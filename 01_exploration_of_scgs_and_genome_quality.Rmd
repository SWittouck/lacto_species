...
ggsave(paste0(dout_all, "/profile_selection.png"), units = "cm", width = 17.4, height = 12)
ggsave(paste0(dout_paper, "/figure_S1_profile_selection.eps"), units = "cm", width = 17.4, height = 12)
```
...
genomes %>%
  ...
  theme_bw()
ggsave(paste0(dout_all, "/genomes_completeness_vs_redunancy.png"), units = "cm", width = 16, height = 16)
```
...
ggsave(paste0(dout_paper, "/figure_1_genome_quality.eps"), units = "cm", width = 17.4, height = 10)
```