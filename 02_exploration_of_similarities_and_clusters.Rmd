...
ggsave("results_v3/figure_S3_exclusivity.png", units = "cm", width = 20, height = 10)
```
...
ggsave(paste0(dout, "/figure_S2_clusters_cnis.png"), units = "cm", width = 20, height = 25)
```
...
ggsave(paste0(dout, "/figure_2.png"), units = "cm", width = 40, height = 20)
```
