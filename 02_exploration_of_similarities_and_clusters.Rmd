...
ggsave(paste0(dout_all, "/exclusivity.png"), units = "cm", width = 16, height = 10)
ggsave(paste0(dout_paper, "/figure_S3_exclusivity.eps"), units = "cm", width = 17.4, height = 10)
```
...
ggsave(paste0(dout_all, "/clusters_cnis.png"), units = "cm", width = 16, height = 25)
ggsave(paste0(dout_paper, "/figure_S2_clusters_cnis.eps"), units = "cm", width = 17.4, height = 25)
```
...
ggsave(paste0(dout_paper, "/figure_2_similarities.tiff"), units = "cm", width = 17.4, height = 9)
```
